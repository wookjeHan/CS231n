...
def ls_discriminator_loss(scores_real, scores_fake):
    ...
    loss = None
    # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
    loss=torch.mean(0.5*((scores_real-torch.ones_like(scores_real))**2))
    loss+=torch.mean(0.5*(scores_fake)**2)
    pass
...
def ls_generator_loss(scores_fake):
    ...
    loss = None
    # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
    loss=torch.mean(0.5*(scores_fake-torch.ones_like(scores_fake).type(dtype))**2)
    pass
